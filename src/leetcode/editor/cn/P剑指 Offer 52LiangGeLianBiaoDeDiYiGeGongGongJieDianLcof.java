...
//Java：两个链表的第一个公共节点
class P剑指Offer52LiangGeLianBiaoDeDiYiGeGongGongJieDianLcof{
    public static void main(String[] args) {      
        Solution solution = new P剑指Offer52LiangGeLianBiaoDeDiYiGeGongGongJieDianLcof().new Solution();
        // TO TEST  
    }
