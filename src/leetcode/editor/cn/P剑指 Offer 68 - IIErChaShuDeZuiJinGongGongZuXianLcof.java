...
//Java：二叉树的最近公共祖先
class P剑指Offer68IIErChaShuDeZuiJinGongGongZuXianLcof{
    public static void main(String[] args) {      
        Solution solution = new P剑指Offer68IIErChaShuDeZuiJinGongGongZuXianLcof().new Solution();
        // TO TEST  
    }
