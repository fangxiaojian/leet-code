...
//Java：链表相交
class P面试题0207IntersectionOfTwoLinkedListsLcci{
    public static void main(String[] args) {      
        Solution solution = new P面试题0207IntersectionOfTwoLinkedListsLcci().new Solution();
        // TO TEST  
    }
