...
//Java：二叉搜索树的最近公共祖先
class P剑指Offer68IErChaSouSuoShuDeZuiJinGongGongZuXianLcof{
    public static void main(String[] args) {      
        Solution solution = new P剑指Offer68IErChaSouSuoShuDeZuiJinGongGongZuXianLcof().new Solution();
        // TO TEST  
    }
...
/**
 * 解答成功:
 * 		执行耗时:7 ms,击败了43.71% 的Java用户
 * 		内存消耗:39.2 MB,击败了99.91% 的Java用户
 */
}